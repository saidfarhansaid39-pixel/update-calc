  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        devanagari: ['var(--font-devanagari)', 'Nirmala UI', 'Lohit Devanagari', 'Arial', 'sans-serif'],
      ...
      animation: {
        ...
        'data-bar': 'data-bar 2s ease-in-out infinite',
      ...
      keyframes: {
        ...
        'logo-glow': {
          '0%, 100%': { filter: 'brightness(1) drop-shadow(0 0 4px rgba(6, 182, 212, 0.3))' },
          '50%': { filter: 'brightness(1.2) drop-shadow(0 0 12px rgba(6, 182, 212, 0.6))' },
        },
        'data-bar': {
