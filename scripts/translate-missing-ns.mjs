...
const PAGES_META = {
  es: {
    ...
    contactMetaDesc:'Póngase en contacto con el equipo de Calculat. Agradecemos sus comentarios y sugerencias.',
  ...
  fr: {
    ...
    contactMetaDesc:"Contactez l'équipe Calculat. Nous apprécions vos commentaires et suggestions.",
  ...
  de: {
    ...
    contactMetaDesc:'Setzen Sie sich mit dem Calculat-Team in Verbindung. Wir freuen uns über Ihr Feedback und Ihre Vorschläge.',
  ...
  pt: {
    ...
    contactMetaDesc:'Entre em contato com a equipe Calculat. Agradecemos seus comentários e sugestões.',
  ...
  ru: {
    ...
    contactMetaDesc:'Свяжитесь с командой Calculat. Мы ценим ваши отзывы и предложения.',
  ...
  ar: {
    ...
    contactMetaDesc:'تواصل مع فريق Calculat. نحن نقدر ملاحظاتك واقتراحاتك.',
  ...
  hi: {
    ...
    contactMetaDesc:'Calculat टीम से संपर्क करें। हम आपकी प्रतिक्रिया और सुझावों का स्वागत करते हैं।',
  ...
  ja: {
    ...
    contactMetaDesc:'Calculatチームにお問い合わせください。ご意見やご提案をお待ちしております。',
    contactTitle:'お問い合わせ',
  ...
  'zh-CN': {
    ...
    contactMetaDesc:'与Calculat团队取得联系。我们欢迎您的反馈和建议。',
    contactTitle:'联系我们',
