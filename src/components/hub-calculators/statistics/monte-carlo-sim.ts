...
const calcDef: CalcDef = {
  ...
  compute: (v) => { const mu = n(v.mean); const sigma = n(v.std); const T = Math.round(n(v.trials)); if (T === 0 || sigma === 0) return { result: 0, label: 'Simulated Mean', unit: '', steps: [] ,
    extras: [
