...
const calcDef: CalcDef = {
  ...
  description: 'Pearson correlation coefficient measures the linear relationship between two variables. r ranges from -1 to +1.',
  formula: 'r = Σ((xᵢ - x̄)(yᵢ - ȳ)) / √(Σ(xᵢ - x̄)² · Σ(yᵢ - ȳ)²)',
  interpretation: 'r = +1: perfect positive, r = -1: perfect negative, r = 0: no linear correlation. |r| > 0.8 indicates strong correlation.'
}
