...
const calcDef: CalcDef = {
    ...
    compute: (v) => {
      ...
      return { result: area, label: 'Sector Area', unit: 'units2', steps: [step('Convert angle:', theta + 'deg = ' + thetaRad.toFixed(6) + ' rad'), step('Formula:', 'A = 1/2 x ' + r + '2 x ' + thetaRad.toFixed(6)), step('Result:', 'A = ' + area.toFixed(6))] }
    },
