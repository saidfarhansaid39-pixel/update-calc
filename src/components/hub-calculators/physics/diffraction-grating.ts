...
const calcDef: CalcDef = {
  ...
  defaults: { linesPerMm: '1', wavelength: '1', order: '1' },
  presets: [
    { label: 'Standard example 1', values: { linesPerMm: '1', wavelength: '1', order: '1' } },
    { label: 'Standard example 2', values: { linesPerMm: '10', wavelength: '10', order: '10' } },
    { label: 'Standard example 3', values: { linesPerMm: '100', wavelength: '100', order: '100' } },
  ],
