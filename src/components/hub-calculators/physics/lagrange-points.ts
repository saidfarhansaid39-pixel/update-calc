...
const calcDef: CalcDef = {
  ...
  defaults: { m1: '1', m2: '1', r: '1' },
  presets: [
    { label: 'Standard example 1', values: { m1: '1', m2: '1', r: '1' } },
    { label: 'Standard example 2', values: { m1: '10', m2: '10', r: '10' } },
    { label: 'Standard example 3', values: { m1: '100', m2: '100', r: '100' } },
  ],
