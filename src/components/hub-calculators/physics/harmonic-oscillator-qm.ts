...
const calcDef: CalcDef = {
  ...
  defaults: { n: '1', frequency: '1' },
  presets: [
    { label: 'Standard example 1', values: { n: '1', frequency: '1' } },
    { label: 'Standard example 2', values: { n: '10', frequency: '10' } },
    { label: 'Standard example 3', values: { n: '100', frequency: '100' } },
  ],
