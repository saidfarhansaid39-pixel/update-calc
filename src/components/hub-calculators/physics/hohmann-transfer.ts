...
const calcDef: CalcDef = {
  ...
  defaults: { r1: '1', r2: '1', mass: '1' },
  presets: [
    { label: 'Standard example 1', values: { r1: '1', r2: '1', mass: '1' } },
    { label: 'Standard example 2', values: { r1: '10', r2: '10', mass: '10' } },
    { label: 'Standard example 3', values: { r1: '100', r2: '100', mass: '100' } },
  ],
