...
const calcDef: CalcDef = {
  ...
  defaults: { mass: '1', radius: '1' },
  presets: [
    { label: 'Standard example 1', values: { mass: '1', radius: '1' } },
    { label: 'Standard example 2', values: { mass: '10', radius: '10' } },
    { label: 'Standard example 3', values: { mass: '100', radius: '100' } },
  ],
