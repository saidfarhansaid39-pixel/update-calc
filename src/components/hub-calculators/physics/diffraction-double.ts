...
const calcDef: CalcDef = {
  ...
  defaults: { wavelength: '1', slitSep: '1', order: '1' },
  presets: [
    { label: 'Standard example 1', values: { wavelength: '1', slitSep: '1', order: '1' } },
    { label: 'Standard example 2', values: { wavelength: '10', slitSep: '10', order: '10' } },
    { label: 'Standard example 3', values: { wavelength: '100', slitSep: '100', order: '100' } },
  ],
