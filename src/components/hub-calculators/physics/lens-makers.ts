...
const calcDef: CalcDef = {
  ...
  defaults: { n: '1', r1: '1', r2: '1' },
  presets: [
    { label: 'Standard example 1', values: { n: '1', r1: '1', r2: '1' } },
    { label: 'Standard example 2', values: { n: '10', r1: '10', r2: '10' } },
    { label: 'Standard example 3', values: { n: '100', r1: '100', r2: '100' } },
  ],
