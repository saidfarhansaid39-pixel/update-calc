  ...
  return (
    <div className="text-[13px] font-sans text-gray-800 leading-relaxed mt-8 space-y-4">
      ...
      <ul className="list-disc pl-8 space-y-2">
        <li><b>Reduce debt in other areas</b>â€”This may include anything from choosing a less expensive car to paying off student loans. In essence, lowering the standard of living in other areas can make it more possible to afford a particularly sought-after house.</li>
        <li><b>Increase credit score</b>â€”A better credit score can help buyers find a loan with a better interest rate. A lower interest rate helps the buyer’s purchasing power.</li>
        <li><b>Bigger down payment</b>â€”Paying more upfront accomplishes two things. One, it directly increases the amount the buyer can afford. Two, a big down payment helps the buyer find a better interest rate and therefore increases the buyer’s purchasing power.</li>
        <li><b>Save more</b>â€”When desired DTI ratios aren’t met, mortgage lenders may look at the amount of savings of each borrower as a compensating factor.</li>
        <li><b>Higher income</b>â€”Although increasing income is easier said than done, it can culminate in the most drastic change in a borrower’s ability to purchase a certain home. A large increase in salary immediately has a large impact on DTI ratios. Acquiring a higher income usually involves different combinations of achieving higher education, improving skills, networking, constant job searching, and typically lots of hard work.</li>
      </ul>
