...
export function SalaryArticle() {
  ...
  return (
    <div className="text-[13px] font-sans text-gray-800 leading-relaxed mt-8 space-y-4">
      ...
      <p className="text-center font-bold">$30 Ã— 8 Ã— 260 = $62,400</p>
      ...
      <p className="text-center font-bold">$30 Ã— 8 Ã— (260 - 25) = $56,400</p>
      ...
      <ul className="list-disc pl-8 space-y-2">
        <li><b>Age</b>â€”A person closer to their peak income years, which is 35-65, will generally have higher salaries. Men aged 35 to 44 had the highest annual earnings at $78,208, and women earned the most between the ages of 35 and 44 at $63,752.</li>
        <li><b>Education</b>â€”The higher the attained level of education of a person, the higher their salary tends to be. Workers 25 or over without a high school degree had median earnings of $40,404 compared to $50,960 for high school graduates. Workers with at least bachelor's degrees earned $95,644 annually on average.</li>
        <li><b>Experience</b>â€”In general, the further entrenched a person is in their career, the more experience or perceived ability they have, or the more valuable their skillset, the higher their salary tends to be.</li>
        <li><b>Race and Ethnicity</b>â€”Black men earned a median salary of $53,664, compared to white men at $70,824. The discrepancy is less for black women compared to white women: $48,204 and $57,254. Hispanic and Asian people of both genders earned $45,088 and $84,240, respectively.</li>
        <li><b>Gender</b>â€”Men earned an average salary of $69,316, and women earned $55,952. Women are generally paid less than men, and this difference is called the gender pay gap. There are many reasons that the pay gap exists, including discrimination, the specific industry, motherhood, and gender roles.</li>
        <li><b>Industry</b>â€”Industry affects wages paid, even in similar roles. For instance, all else being equal, an office clerk at a public school system will most likely make a lower salary than one at a private hedge fund. This also includes the relative stability of industries and companies and their forecasted trends.</li>
        <li><b>Location</b>â€”Different locations will have different supplies and demands for positions, and average salaries in each area will reflect this. Keep in mind that the cost of living should be noted when comparing salaries. In some cases, a job that offers a higher salary may equate to less overall once the cost of living of a different location is accounted for.</li>
        <li><b>Misc.</b>â€”To a lesser extent, salary is also influenced by the overall performance of companies; during years of high profits, a company may choose to pay a higher than average salary for a job applicant with excellent credentials. Also, in certain jobs, workers are expected to perform job responsibilities in dangerous working conditions, such as handling dangerous chemicals in a research facility, working in an underground mine with the presence of potential toxins, or patrolling a notoriously dangerous part of town as a police officer. Such jobs can be compensated with a higher salary in the form of hazard pay. Similarly, people who work less favorable shift hours, such as the "graveyard shift," which runs through the early hours of the morning, can sometimes earn a premium for doing so, due to the higher social and physical costs of working outside normal hours.</li>
      </ul>
