    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <SchemaMarkup
        ...
        data={{
          '@type': 'WebPage',
          name: 'Privacy Policy',
          description: 'Privacy Policy for Calculat - how we handle your data and protect your privacy.',
          url: `${siteUrl}/privacy`,
      ...
      <div className="prose dark:prose-invert max-w-none space-y-4">
        ...
        <p>For privacy-related inquiries, contact us at support@calculat.online.</p>
      </div>
    </div>
  )
}
